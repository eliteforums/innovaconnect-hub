...
const tracks = [
  ...
  },
  {
    ...
    description:
      "Build autonomous intelligence. AI agents, multi-agent systems, and intelligent automation — create systems that think, plan, and execute.",
    sponsors: "AI and Agentic AI companies",
    examples: [
